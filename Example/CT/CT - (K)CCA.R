...
Scores.CT.CCA = Analysis(Returns, Predictions.CT.CCA, Q=(1:4)/4, r=30)
...
Scores.CT.KCCA = Analysis(Returns, Predictions.CT.KCCA, Q=(1:4)/4, r=30)
...
CumSum.CT.KCCA= CreatePlot.CumSumPnL(Scores = list(Scores.CT, Scores.CT.CCA, Scores.CT.KCCA),
                                     Labels = c("CT", "CT CCA", "CT KCCA"),
                                     BaseModels = 1,
                                     Type="CT")


SharpePPT.CT.KCCA = CreatePlot.SharpePPT(Scores = list(Scores.CT, Scores.CT.CCA, Scores.CT.KCCA),
                                         Labels = c("CT", "CT CCA", "CT KCCA"),
                                         BaseModels = 1,
                                         Type="CT")
