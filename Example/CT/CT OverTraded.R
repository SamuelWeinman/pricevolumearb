...
Scores.CT.OverTraded = Analysis(Returns=Returns,
                                Predictions = Predictions.CT.OverTraded,
                                r=30, Q=(1:4)/4)


SharpePPT.CT.Overtraded = CreatePlot.SharpePPT(Scores =list(Scores.CT,Scores.CT.OverTraded),
...
CumSum.CT.Overtraded = CreatePlot.CumSumPnL(Scores =list(Scores.CT,Scores.CT.OverTraded),
                                            Labels = c("CT", "CT Decomposed Volume"),
                                            BaseModels = 1,
                                            Type="CT")
