...
CumSum.Base <- createCumSumPnLPlot(
  Scores = list(Scores.CS, Scores.CT),
  Labels = c("Cross-Sectional", "Cross-Temporal"),
  Type = "BASE"
)


SharpePPT.Base <- createSharpePPTPlot(
  Scores = list(Scores.CS, Scores.CT),
  BaseModels = 1:2,
  Labels = c("Cross-Sectional", "Cross-Temporal"),
  Type = "BASE"
...
CumSum.Base.ME <- createSharpePPTPlot(
  Scores = list(Scores.CS.ME, Scores.CT.ME),
  Labels = c("CS", "CT"),
  BaseModels = 1:2,
  Type = "BASE",
  Title = "Market Excess"
