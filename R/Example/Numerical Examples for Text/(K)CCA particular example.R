...
plotXY = ggplot(dataXY, aes(x = X, y = Y)) +
  geom_point(col = "#F8766D") + ggtitle("Original Data") +
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank()) +
  theme(axis.text.y = element_blank(), axis.ticks.y = element_blank()) +
  xlab(TeX("$x^{(1)}$")) + ylab(TeX("$y^{(1)}$"))
...
plotXY.K = ggplot(dataXY.K, aes(x = X, y = Y)) +
  geom_point(col = "#619CFF") + ggtitle("KCCA Transformed Data") +
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank()) +
  theme(axis.text.y = element_blank(), axis.ticks.y = element_blank()) +
  xlab(TeX("$x^{(1)}$")) + ylab(TeX("$y^{(1)}$"))
...
ggsave(filename = "KCCA.TransformedData.png", 
