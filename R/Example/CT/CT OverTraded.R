...
Scores.CT.OverTraded <- performFullAnalysis(
  Returns = Returns,
...
SharpePPT.CT.Overtraded <- createSharpePPTPlot(
  Scores = list(Scores.CT, Scores.CT.OverTraded),
...
ggsave(
  filename = "SharpePPT.CT.Overtraded.png",
...
CumSum.CT.Overtraded <- createCumSumPnLPlot(
  Scores = list(Scores.CT, Scores.CT.OverTraded),
  Labels = c("CT", "CT Decomposed Volume"),
  BaseModels = 1,
  Type = "CT"
...
ggsave(
  filename = "CumSum.CT.Overtraded.png",
  path = "C:\\Users\\Samuel Weinman\\OneDrive - Nexus365\\Documents\\MSc Statistical Science\\Dissertation\\Results\\Plots",
