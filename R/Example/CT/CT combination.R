Predictions.CT.Combined <- combinePrediction(
  strongPredictions = Prediction.CT.KPCA,
...
SharpePPT.CT.Combined <- createSharpePPTPlot(
  Scores = list(Scores.CT, Scores.CT.KPCA, Scores.CT.OverTraded, Scores.CT.Combined),
...
ggsave(
  filename = "SharpePPT.CT.Combined.png",
