...
Scores.CS.Overtraded = Analysis(Returns = Returns,
                         Predictions=Prediction.CS.Overtraded,
                         Q=(1:4)/4,r=30)


SharpePPT.CS.Overtraded = CreatePlot.SharpePPT(Scores =list(Scores.CS,Scores.CS.Overtraded),
                                         Labels = c("CS", "CS Decomposed Volume"),
                                         BaseModels = 1,
                                         Type="CS")


ggsave(filename = "SharpePPT.CS.Overtraded.png", 
...
CumSum.CS.Overtraded = CreatePlot.CumSumPnL(Scores =list(Scores.CS,Scores.CS.Overtraded),
                                            Labels = c("CS", "CS Decomposed Volume"),
                                            BaseModels = 1,
                                            Type="CS")


ggsave(filename = "CumSum.CS.Overtraded.png", 
       path = "C:\\Users\\Samuel Weinman\\OneDrive - Nexus365\\Documents\\MSc Statistical Science\\Dissertation\\Results\\Plots",
