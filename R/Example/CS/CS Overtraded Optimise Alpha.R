...
ggsave(
  filename = "Performance.OverTrading.png",
...
SharpePPT.OT.CS.OverAlpha <- createSharpePPTPlot(
  Scores = S[seq(1, 15, by = 2)],
...
ggsave(
  filename = "SharpePPT.OT.CS.OverAlpha.png",
  path = "C:\\Users\\Samuel Weinman\\OneDrive - Nexus365\\Documents\\MSc Statistical Science\\Dissertation\\Results\\Plots",
