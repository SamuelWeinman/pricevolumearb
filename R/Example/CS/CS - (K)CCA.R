...
Scores.CS.CCA = Analysis(Returns = Returns,
...
Scores.CS.KCCA = Analysis(Returns = Returns,
...
SharpePPT.CS.KCCA = CreatePlot.SharpePPT(Scores =list(Scores.CS, Scores.CS.CCA, Scores.CS.KCCA),
...
CumSum.CS.KCCA = CreatePlot.CumSumPnL(Scores =list(Scores.CS, Scores.CS.CCA, Scores.CS.KCCA),
                                      Labels = c("CS", "CS CCA", "CS KCCA"),
                                      BaseModels = 1,
                                      Type = "CS")
