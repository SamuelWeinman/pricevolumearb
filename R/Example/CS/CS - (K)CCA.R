...
Scores.CS.CCA <- performFullAnalysis(
  Returns = Returns,
...
Scores.CS.KCCA <- performFullAnalysis(
  Returns = Returns,
...
SharpePPT.CS.KCCA <- createSharpePPTPlot(
  Scores = list(Scores.CS, Scores.CS.CCA, Scores.CS.KCCA),
...
ggsave(
  filename = "SharpePPT.CS.KCCA.png",
...
CumSum.CS.KCCA <- createCumSumPnLPlot(
  Scores = list(Scores.CS, Scores.CS.CCA, Scores.CS.KCCA),
  Labels = c("CS", "CS CCA", "CS KCCA"),
  BaseModels = 1,
  Type = "CS"
