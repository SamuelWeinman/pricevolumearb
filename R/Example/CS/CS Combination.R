Predictions.CS.Combined <- combinePrediction(
  strongPredictions = Predictions.CS.Cluster.Weighted$Predictions,
...
Scores.CS.Combined <- performFullAnalysis(
  Returns = Returns,
...
SharpePPT.Combined <- createSharpePPTPlot(
  Scores = list(
    Scores.CS,
...
### SAVE
ggsave(
  filename = "SharpePPT.Combined.png",
...
CumSum.Combined <- createCumSumPnLPlot(
  Scores = list(
    Scores.CS,
    Scores.CS.Cluster.Weighted,
    Scores.CS.VW.Divide[[1]],
